...
export function TypewriterEffectDemo() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-[20rem] w-100">
      
      <span className="text-[40px] sm:text-2xl md:text-5xl lg:text-5xl font-bold text-center">Lionel Abatan</span>
